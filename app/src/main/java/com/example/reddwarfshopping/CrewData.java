...
public class CrewData {
    ...
    static List<Crew> addCrewMembers() {
        ...
        crewList.add(new Crew("Hilly", "Hilly", "Red Dwarf computer", "Artificial Intelligence", "What?!", "Holly Room, originally Earth", "https://static.wikia.nocookie.net/reddwarf/images/a/a2/Obrazovka_hilly01.jpg/revision/latest?cb=20140603014558"));
        crewList.add(new Crew("Kristine Z. Kochanski", "Krissie", "Human", "Navigation Officer", "Let's at least ask someone who's at least going to give us a slightly more intelligent opinion. Hello, wall! What do you think?", "Earth", "https://static.wikia.nocookie.net/reddwarf/images/1/1b/Kochanski_frankenstein.jpg/revision/latest?cb=20140618174247"));
